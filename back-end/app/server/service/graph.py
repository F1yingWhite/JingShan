...
def get_graph_by_name(name: str):
    ...
    if not main_node_category_exist:
        category_set.add("查询对象")
        node_category_map[name] = "查询对象"
    print(category_set)
